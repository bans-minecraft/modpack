...
- Current Release: [2023-12-03](https://git.blakerain.com/bans-minecraft/modpack/releases/tag/2023-12-03)
...
- **Canary** a general-purpose optimization mod and unofficial fork of the Fabric mod [**Lithium**](https://www.curseforge.com/minecraft/mc-mods/lithium) for Minecraft Forge.
- **Jade** Minecraft mod shows what you are looking at.
- **Oculus** Unofficial Fork of "Iris", made to work with FML
- **Rubidium** An Unofficial Fork of the Sodium maked to work on FML.
...
The following table lists the mod files that are included in this pack.
